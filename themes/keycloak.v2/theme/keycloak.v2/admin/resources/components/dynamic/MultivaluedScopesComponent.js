...
import {Button, Chip, ChipGroup, FormGroup} from "../../_snowpack/pkg/@patternfly/react-core.js";
  ...
  return /* @__PURE__ */ React.createElement(FormGroup, {
    ...
    render: ({onChange, value}) => {
      return /* @__PURE__ */ React.createElement(React.Fragment, null, open && /* @__PURE__ */ React.createElement(AddScopeDialog, {
        clientScopes: localeSort(clientScopes.filter((scope) => !value.includes(scope.name)), mapByKey("name")),
      ...
      }), value.length === 0 && !conditionName && /* @__PURE__ */ React.createElement(KeycloakTextInput, {
        type: "text",
        id: "kc-scopes",
        value,
